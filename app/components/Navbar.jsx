...
const Navbar = () => {
  ...
  return (
    <header
      className={`flex z-20 fixed top-0 items-center justify-between py-5 font-medium w-full left-0 px-6 md:px-16 lg:px-32 transition-all duration-300 ${
        scrolled ? "bg-white shadow-md py-8" : "bg-transparent"
      }`}
    >
      <Link href="/">
        <Image
      ...
      {/* Sidebar Menu Mobile */}
      <div
        className={`fixed top-0 left-0 right-0 z-20 bg-white transition-all duration-500 overflow-hidden ease-in ${
          visible ? "h-full" : "h-0"
        }`}
      >
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <Image
                          ...
                          alt="Dropdown Arrow"
                          className={`w-5 transition-transform duration-300 ${
                            isRotatedMobile ? "rotate-180" : "rotate-0"
                          }`}
                        />
                      </div>
                    </div>
